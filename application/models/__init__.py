...
from .Comment.comment import (add_comment,
                       delete_comment,
                         ...
                         unlike_comment,
                         comment_user_post)
from .jointQuery.jointQuery import user_community_member,communityinfo_communitypost_communityactivity
...
__all__ = [
    ...
    'add_community_info', 'delete_community_info', 'search_community_info', 
    ...
    'add_community_post', 'delete_community_post', 'search_community_post',
    ...
    'user_community_member','communityinfo_communitypost_communityactivity',
    ...
    'user_like_post','user_collect_post'
    ]